...
if (isset($_GET["id"])) {
    ...
    $lodging_budget = 0;
    $total_budget = $experience["booking_fee"];
                ...
                <section>
                    <div class="row">
                        <div class='col-lg-6 p-3 border-lg-end border-blue'>
                            ...
                            <?php
                            if(isset($invoice_id)){
                                $invoice_text = "<p class='easygo-fw-1 easygo-fs-3'>Invoice $invoice_id</p>";
                            }else{
                                $invoice_text = "";
                            }
                            ...
                            <div class='mt-3 mb-1 d-flex justify-content-between'>
                                <div>Bill to <span class='text-blue easygo-fs-3 easygo-fw-1'>$username</span></div>
                            </div>
                            $invoice_text
                            <div class='my-4'>
                            ...
                            <div class='justify-content-end'>
                                <div class='row'>
                                    <div class='col-6'>
                                        <a href='#' onclick=\"make_trip_payment()\" class='easygo-btn-5 bg-orange text-white easygo-fs-5 flex-grow-1'>Pay Now</a>
                                    </div>
                                    <div class='col-6'>
                        ...
                        <div class="position-relative">
                            <div>
                                <div class="my-4">
                                    ...
                                    $div_text = "<h3 class='easygo-fw-1 m-0'>$current_day</h3>";
