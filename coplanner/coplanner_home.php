                    ...
                    <div class="col-lg-6 p-3 d-flex flex-column justify-content-center">
                        <div class="d-flex flex-column gap-5">
                            ...
                            <div class='d-flex justify-content-between gap-4'>
                                <a href='#' class='easygo-btn-5 bg-blue text-white easygo-fs-5 w-50'>Try for business</a>
                                <a href='#' class='easygo-btn-4 border-blue text-blue easygo-fs-5 w-50 bg-white'>Try for individuals</a>
                            </div>
                        </div>
                    </div>
