        ...
        <main class="container" style="height: 100vh; padding-top: 9rem; padding-bottom: 3rem;">
            <div id="setup-pages" class="eh-transition-box h-100">
                ...
                <section id="activities-selection-page" class="eh-transition-page">
                    ...
                    <div>
                        <div class="mt-auto">
                            <h4 class="text-center fw-bold mb-5">What type of activities would you like?</h4>
                        </div>
                        <div class="row">
                ...
                <section id="budget-selection-page" class="eh-transition-page">
                    ...
                    <div>
                        ...
                        <div class="row">
                            <div class="col-md-4 p-3">
                                <div class="easygo-radio-btn-1">
                                    <input type="radio" name="budget-range-selection" id="under-500-select">
                            ...
                            <div class="col-md-4 p-3">
                                <div class="easygo-radio-btn-1">
                                    <input type="radio" name="budget-range-selection" id="500-to-2000-select">
                                    <label class="easygo-icon-btn py-5 text-blue" for="500-to-2000-select">
                                        <h3>GHS 500 - GHS 2000</h3>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-4 p-3">
                                <div class="easygo-radio-btn-1">
                                    <input type="radio" name="budget-range-selection" id="over-2000-select">
