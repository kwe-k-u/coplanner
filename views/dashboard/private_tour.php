                                                    ...
                                                    <div class='w-100'>
                                                        ...
                                                        <div class='d-flex justify-content-between'>
                                                            ...
                                                            <div class='d-flex gap-1'>
                                                                ...
                                                                <button onclick='return goto_page(\"views/dashboard/private_tour_quotes.php?request_id=$tour_id\")' class='easygo-btn-5 bg-lblue-1 easygo-rounded-1 easygo-fs-5 px-2'><i class='fa-solid fa-eye'></i> &nbsp; View Quotes</button>
                                                                <button onclick='edit_request(\"$tour_id\")' data-visibility-target='.request-tour' class='easygo-rounded-1 easygo-fs-5 easygo-btn-1 py-1 easygo-fw-3 visibility-changer'><i class='fa-solid fa-pen'></i> &nbsp; Edit Request</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>";
                            ...
                            <div class="book-private-tour request-tour" style="display: none;">
                                ...
                                <div class="form-page-main container d-block">
                                    <div class="form-container container" style="max-width: 600px;">
                                        <form onsubmit=request_private_tour(this)>
                                            <?php
                                            ...
                                            <div class="form-input-field">
                                                <textarea name="desc" class="border-blue" style="resize: none" cols="30" rows="7"
                                                placeholder="Describe your vision for the tour as much as you can. Eg: I want a tour for my friends and I where we get to visit the Kakum National Park. We are open to spending the night in the town and visiting other sites. The following day we would like to go hiking through Aburi too but its fine if we cant do that on this trip ">Going to town</textarea>
                                            </div>

                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="input-field">
                                                        <div class="text-gray-1 easygo-fs-5">Budget</div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div class="text-gray-1 easygo-fs-5">Min</div>
                                                            <input name="min_b" type="text" value="200" class="border-blue">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="input-field">
                                                        ...
                                                        <div name="max_b" class="text-gray-1 easygo-fs-5">Max</div>
                                                            <input name="max_b" value="500" type="text" class="border-blue">
                                                        </div>
                                                    </div>
                                                </div>
                                            <div class="row">
