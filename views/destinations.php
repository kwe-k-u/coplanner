			...
			<div class="destination-list" id="destination-list">
				<?php
					...
					foreach ($destinations as $entry) {
						...
						$destination_image = server_base_url()."assets/images/site_images/sorry_".rand(1,2).".jpg";
		...
		<nav id="bottom-selection-info" class="bottom-selection-info">
			...
			<div class="d-flex ">
				...
				<div>
					<?php
						echo "
						<button class='btn easygo-btn-1' onclick='goto_page(\"views/preview.php?experience_id=$experience_id\")'>Continue</button>
						";
					?>
				</div>
			</div>
