                    ...
                    <div class="row">
                        ...
                        <div class='trip-card'>
                            ...
                            <div class='trip-card-footer'>
                                <h3>$currency $fee</h3>
                                <a href='tour_description.php?tour_id=$tour_id' class='easygo-btn-1'>View tour</a>
                            </div>
                        </div>
                    </div>
                                    ";
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 py-5">
                            <div class="container-fluid">
                                <h1>Co-create the perfect tour</h1>
                                <p>
                                    Sometimes, you know exactly what you want. Why not tell us! easyGo allows you to describe your
                                    perfect tour and request bids from tour companies who will bring your adventure to life. Create a
                                    tour request now!
                                </p>
                                <button type="button" onclick="return goto_page('views/dashboard/private_tour.php')" class="easygo-btn-2 easygo-fs-4 easygo-fw-3 px-5" style="border-radius: 50px; word-spacing: 5px;"> Private Tours</button>
