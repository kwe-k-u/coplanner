		...
		<!-- <li>
			<div class="slide-down-menu">
				...
				<ul id="trips-submenu-sb" class="sub-menu slide-down-sub-menu">
					<li><a href="template_itineraries.php" id="nav_sub_groups">Group Tours</a></li>
					<li><a href="private_tours.php" id="nav_sub_private">Private Tours</a></li>
				</ul>
			</div>
		</li> -->

		<li><a href="bookings.php" id="nav_finance"><img src="../assets/images/svgs/finance.svg"  alt="finance icon"> Bookings</a></li>
