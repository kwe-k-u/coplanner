<?php
	...
	function upload_user_media_ctrl($media_id, $user_id,$location){
		$media = new media_class();

		return $media->add_media_cls($media_id,$location)
		&& _link_user_upload_ctrl($user_id,$media_id);
	}


	function upload_curator_media_ctrl($media_id, $curator_id,$location){
		$media = new media_class();
	...
	function upload_campaign_media_ctrl($media_id, $campaign_id,$location){
		$media = new media_class();
