				...
				<div class="main-content px-3">
					<section class="create-trip">
						...
						<form id="create_trip_form" onsubmit="return submit_tour(this)">
							...
							<div class="row border-1 border-bottom py-4 pe-lg-5">
								<div class="col-lg-5">
									<h3 class="easygo-fs-3 easygo-fw-1">Tour site Description</h3>
									<p class="text-gray-1 easygo-fs-5">Tell us about this location</p>
								</div>
								<div class="col-lg-7">
									<div>
									</div>
									<div class="form-input-field">
										<textarea name="description" style="resize: none" rows="7" placeholder="Tour site description"></textarea>
									</div>
								</div>
							</div>
							<!-- Tour images  -->
							<div class="row border-1 border-bottom py-4 pe-lg-5">
								<div class="col-lg-5">
									<h3 class="easygo-fs-3 easygo-fw-1">Tour site Images</h3>
									<p class="text-gray-1 easygo-fs-5">Add images of the location</p>
								</div>
								<div class="col-lg-7">
									<div>
										<div id="tripimages-upload-btn" data-bs-toggle="modal" data-bs-target="#upload-img-modal" data-visibility-target=".cover_or_trip-imgs" data-visibility-show="#trip-imgs-upload-outer" class="file-input visibility-changer">
											...
											<a>Click to upload</a>
											<span class="text-gray-1">SVG , PNG or JPG (800 x 400 px)</span>
							...
							<div class="row border-1 border-top border-bottom py-4 pe-lg-5">
								<div class="col-lg-5">
									<h3 class="easygo-fs-3 easygo-fw-1">Site Activities</h3>
									<p class="text-gray-1 easygo-fs-5">Give us a list of all the activities you know are available at the tour site</p>
								</div>
								<div class="col-lg-7 d-flex flex-column gap-4">
									<div class="row" id="occurance_field">
										<div class="col-lg-6 p-0 pe-lg-1 pb-3">
											...
											<div class="form-input-field">
												<h6 class="easygo-fs-4 text-gray-1">Activity Name</h6>
												<input id="seats" type="text" min="1">
											</div>
											<div class="form-input-field">
												<h6 class="easygo-fs-4 text-gray-1">Activity Fee</h6>
												<div class="d-flex">
													<div class="dropdown">
									...
									<div id="occurance_list" class="easygo-list-3 list-striped">
										<div class="list-item list-header bg-transparent" style="box-shadow: none;">
											<div class="inner-item">Activity Name</div>
							...
							<div class="row border-1 border-top border-bottom py-4 pe-lg-5">
								<div class="col-lg-5">
									<h3 class="easygo-fs-3 easygo-fw-1">Site Activities</h3>
									<p class="text-gray-1 easygo-fs-5">Other information relevant to the tour site</p>
								</div>
								<div class="col-lg-7 d-flex flex-column gap-4">
									<div class="row" id="occurance_field">
										<div class="col-lg-6 p-0 pe-lg-1 pb-3">
											...
											<div class="form-input-field mt-3">
												<h6 class="easygo-fs-4 text-gray-1">Name of contact person at tour site</h6>
												<input id="seats" type="text" min="1">
											</div>
											<div class="form-input-field mt-3">
												<h6 class="easygo-fs-4 text-gray-1">Phone number of contact person at tour site</h6>
												<input id="seats" type="text" min="1">
											</div>
											<div class="form-input-field mt-3">
